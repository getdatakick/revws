...
class Settings
{
    ...
    public function get($path = null)
    {
        ...
        foreach ($path as $key) {
            if (isset($value[$key])) {
                ...
                throw new RuntimeException('Setting not found: ' . implode('>', $path));
            }
        }
        return $value;
    }
    ...
    public function getInstallationDate()
    {
        ...
        try {
            ...
            throw new RuntimeException("Failed to create date object", 0, $e);
        }
    }
    ...
    {
        return (string)Configuration::getGlobalValue(self::VERSION);
    }
